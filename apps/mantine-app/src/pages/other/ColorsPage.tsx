import { Title, Text, Code, Center, Group, Card, Stack, Box, Grid, Divider } from '@good/ui/core';
		...
		<DefaultLayout title='Colors' subtitle='Color palette' headerSize='xl' containerSize='xl'>
			...
			<Content.Section title='Range of brand colors' divider={false}>
				<Content.Text>
					...
					These colors are used available as a CSS variable, and can be accessed in the various components like the following example:{' '}
					<br /> <br />
				</Content.Text>
				...
				<Content.Area>
					...
					<Box mb='4rem'>
						...
						<Grid gutter='lg'>
							...
							<ColorItem
								span={2}
								bg='var(--brand-accent-light-1)'
								category='Accent'
								color='accent-light-1'
								tc='var(--brand-accent-dark-2)'
							/>
							<ColorItem
								span={2}
								bg='var(--brand-accent-light-2)'
								category='Accent'
					...
					<Box mb='4rem'>
						...
						<Grid gutter='lg'>
							...
							<ColorItem
								span={2}
								bg='var(--color-lavender-light-1)'
								category='Lavender'
								color='lavender-l-1'
								tc='var(--color-lavender-dark-2)'
							/>
							<ColorItem
								span={2}
								bg='var(--color-lavender-light-2)'
								category='Lavender'
								color='lavender-l-2'
								tc='var(--color-lavender-dark-2)'
							/>
							<ColorItem
								span={2}
								bg='var(--color-lavender-ref)'
								category='Lavender'
								color='lavender-ref'
								tc='var(--color-lavender-light-2)'
							/>
						</Grid>
					</Box>
