    ...
    <DefaultLayout title="TextInput" subtitle="Boxes for you to enter text">
      ...
      <Content.Section>
        ...
        <Stack gap="lg">
          ...
          <TextInput
            label="Spirit animal"
            description="What is your spirit animal?"
            placeholder="Describe your spirit animal..."
          />
        </Stack>
      </Content.Section>
      ...
      <Content.Section>
        ...
        <Stack align="flex-start" gap="xl">
          <TextInput
            label="Error state"
            placeholder="This TextField contains errors"
            style={{ width: "400px" }}
            error
          />
          <TextInput
            label="Disabled state"
            placeholder="This TextField is disabled."
            style={{ width: "400px" }}
            disabled
          />
        </Stack>
